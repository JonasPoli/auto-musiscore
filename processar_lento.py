...
DEFAULT_DIR = ROOT / "output_meia_hora" / "orgao_eletronico_drawbar"
...
def process_file(mp3_path, hino_id, output_dir):
...
def main():
    ...
    with ProcessPoolExecutor(max_workers=os.cpu_count()) as executor:
        futures = {executor.submit(process_file, t[0], t[1], target_dir): t for t in tasks}
