    ...
    for idx, conf in enumerate(instruments_config):
        ...
        for track in mid.tracks:
            ...
            for note_info in notes:
                ...
                duration = remove_staccato(duration, ticks_per_beat)
                off_time_new = on_time_new + duration
...
def main():
    ...
    ap.add_argument("--output",     default="output/strings",      help="Pasta de saída para os arquivos MP3")
    ...
    for idx, path in enumerate(midi_files, 1):
        ...
        temp_midi = os.path.join(args.output, f"{name}.mid")
